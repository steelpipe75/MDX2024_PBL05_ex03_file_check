...
def check_csv_file(input):
    ...
    if is_index_1st_column_equal:
        st.write("⭕️一列目が行番号と等しいかどうかチェックOK")
    else:
    ...
    if is_index_1st_column_equal:
        st.write("⭕️二列目に無効な値（NaNや空白）があるかチェックOK")
    else:
